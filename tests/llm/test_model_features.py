...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('gemini-2.5-pro', True),
        ('llama-3.1-70b', False),  # Most open source models don't support native function calling
...
def test_get_features_case_insensitive():
    ...
    assert features_lower.supports_function_calling == features_upper.supports_function_calling
    assert features_lower.supports_reasoning_effort == features_upper.supports_reasoning_effort
    assert features_lower.supports_function_calling == features_mixed.supports_function_calling
...
def test_get_features_with_version_suffixes():
    ...
    assert base_features.supports_function_calling == versioned_features.supports_function_calling
    assert base_features.supports_reasoning_effort == versioned_features.supports_reasoning_effort
    assert base_features.supports_prompt_cache == versioned_features.supports_prompt_cache
